        ...
        private Kit TR909 = new Kit() {
            ...
            Grid = new Grid() {
                GridItems = new List<GridItem>() {
                    new GridItem() { X=0,Y=0,Name="Bass Drum",Note=35, Samples= new List<Sample>() { new Sample(35, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_BD01.wav") } },
                    new GridItem() { X=1,Y=0,Name="E-Bass Drum",Note=36, Samples= new List<Sample>() { new Sample(36, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_BD01.wav") } },
                    new GridItem() { X=2,Y=0,Name="Pedal-HH",Note=44, Samples= new List<Sample>() { new Sample(44, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_HH01.wav") } },
                    new GridItem() { X=3,Y=0,Name="Closed-HH",Note=42, Samples= new List<Sample>() { new Sample(42, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_HH07.wav") } },
                    new GridItem() { X=0,Y=1,Name="Open-HH",Note=46, Samples= new List<Sample>() { new Sample(46, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_HHO1.wav") } },
                    new GridItem() { X=1,Y=1,Name="Crash 1",Note=49, Samples= new List<Sample>() { new Sample(49, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_HHZ CRSH1.wav") } },
                    new GridItem() { X=2,Y=1,Name="Crash 2",Note=57, Samples= new List<Sample>() { new Sample(57, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_HHZ CRSH2.wav") } },
                    new GridItem() { X=3,Y=1,Name="Ride 1",Note=51, Samples= new List<Sample>() { new Sample(51, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_HHZ RIDE1.wav") } },
                    new GridItem() { X=0,Y=2,Name="Snare Drum",Note=38, Samples= new List<Sample>() { new Sample(38, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_SD 01.wav") } },
                    new GridItem() { X=1,Y=2,Name="Handclap",Note=40, Samples= new List<Sample>() { new Sample(40, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_SD CLAP1.wav") } },
                    new GridItem() { X=2,Y=2,Name="High Tom",Note=50, Samples= new List<Sample>() { new Sample(50, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_TOM HI1.wav") } },
                    new GridItem() { X=3,Y=2,Name="Mid Tom",Note=48, Samples= new List<Sample>() { new Sample(48, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_TOM ME1.wav") } },
                    new GridItem() { X=0,Y=3,Name="Low Tom",Note=45, Samples= new List<Sample>() { new Sample(45, @"C:\Github\repositories\AccuDrums\VstNetMidiPlugin\Kits\TR-909\TR909_TOM LO1.wav") } },
                },
                XSize = 4,
                YSize = 4,
            }
